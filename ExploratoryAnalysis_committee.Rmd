...
Correlate the residuals of this April KBDI model with the number of acres burned in the season prior
when correlating the number of acres burned to the KBDI model, we find no relationship. Correlation coefficent = -0.0197
```{r}
