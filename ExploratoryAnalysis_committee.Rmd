...
Create 4 panel plot showing showing 1940 and 1941 side by side.
The 1940 data does not start until March. Should these be compared, or should another full year date be chosen?
Only use one legend to represent plot.
Could net rainfall plot use bars rather than lines?
```{r}
((p2_1940 + ylim(0,5)) + (p2_1991 + ylim(0, 5) + scale_x_date(date_labels = "%b %Y"))) / (p1_1940 + (p1_1991 + scale_x_date(date_labels = "%b %Y"))) +
  plot_annotation(
    title = "KBDI values merge with time regardless of initial Q-values",
    subtitle = "Q-values intialized at 0, 400, and 800",
