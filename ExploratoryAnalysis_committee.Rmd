...
How do monthly KBDI trends vary Annually? Is ther a drying trend with time?
...
Whats the relationship between April KBDI and the accuracy of the predicted fire count. Use the absolute value to demonstate how far the predictied value is off of the actual value. This correlation returns 0.693. How is this interpreted/ how should the relationship be summarized?
```{r}
