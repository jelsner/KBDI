...
How can this help to answer the question of predicting fires for May, June and July each season.
...
ggplot(mapping = aes(x = AprilStats$April_Avg, y = pred_AprilGLM$fit)) +
  ...
  xlab("Average KBDI") +
  labs(
    title = "Predicted Probability of Fire Occurrence Based on April Averaged KBDI",
    subtitle = "With 95% Confidence Interval",
