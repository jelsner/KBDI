...
We find that the April KBDI Average is not statistically significant
THe correlation is slightly stronger than mode that was run without max and min KBDI
```{r}
