...
Could the number of fires over the previous year influence the number of fires in the upcoming season? Explore all fires outside of natural fires. How might the area burned over the last year be relevant?
