...
The KAAF data set is much smaller (date range 1940 - March 2013). Therefore this will be on the left, and all TLH dates before 1940 and after 2013 will be ignored. These values are not needed since they can not be compared.
