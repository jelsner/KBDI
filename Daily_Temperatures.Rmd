...
While a warmer than usual day in December will be experienced as quite pleasant a warmer than usual day in July likely will be experienced as dreadful.
...
Make a tibble composed of tibbles with `group_by()` followed by `nest()`.
```{r}
by_doy <- TLH.df |>
  group_by(doy) |>
  nest()
