...
#https://services3.arcgis.com/T4QMspbfLg3qTGWY/arcgis/rest/services/Fire_History_Locations_Public/FeatureServer/0/query?outFields=*&where=1%3D1

#Fires2.sf <- st_read("NIFC_Fires_ANF.shp")
```
...
ggplot(data = TLH.df, 
  ...
  geom_tile() +
  scale_y_reverse(breaks = seq(1948, 2020, 4)) +
...
exp(coef(glm.nb(nFires ~ I(QlmLastDay / 10) + SOI, data = df))) # 1.189 or 19% increase in the risk of a wildfire per cm increase in soil moisture deficit
