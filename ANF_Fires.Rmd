...
Make fire size and ordered factor and create a model that predicts the probability by size category similar to EF rating.
```{r}
Fires.sf %>%
  group_by(FIRE_SIZE_) %>%
  summarize(Range1 = range(FIRE_SIZE)[1],
