...
ggplot(TLH.df, aes(x = Date, y = Qlm)) +
  geom_line() +
  scale_y_continuous() +
  ylab("") + xlab("") +
...
#          subtitle = "Based on data from the NWSFO, Tallahassee, FL  (1946-2019)")
```

Linear trend model.
```{r}
summary(lm(Qlm ~ Date, data = TLH.df)) # this assumes daily Qlm are independent
