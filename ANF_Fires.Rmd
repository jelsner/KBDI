...
Title: Predicting the frequency and severity of lightning-sparked wildfires in the Apalachicola National Forest
...
Map of lightning-sparked fires by size of the area burned.
```{r}
