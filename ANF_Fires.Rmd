...
Cloud to ground lightning is most common in the ANF between June through August. The natural wildfire season is the cross correlation between the dry season and the lightning season. https://en.wikipedia.org/wiki/Cross-correlation

## Get TLH airport daily weather data and compute the Keetch & Byram drought index

Drought indices: https://piahs.copernicus.org/articles/383/291/2020/
