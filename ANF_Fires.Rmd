---
title: "Lightning Caused Fires in the Apalachicola National Forest (ANF)"
...
Area burned versus number of fires 
...
ggplot(df,
  ...
  ylab("") + xlab("") +
  labs(label = "Lightning is the predominant cause of wildfires in the Apalachicola National Forest",
       subtitle = "Based on data from 1992-2015",
       caption = "Data source: Short, Karen (2017)") +
  theme_minimal()
```

Map of all locations of all fires over the period.
```{r}
tm_shape(ANF_Boundary.sf) +
  tm_borders() +
tm_shape(Fires.sf) +
  tm_bubbles(size = "FIRE_SIZE") +
tm_shape(Airport.sf) +
