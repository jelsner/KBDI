...
appendix_table.df <- temp_cm %>%
  dplyr::select("Year":"Qlcm", "burnedGroupInterval":"acresBurned") %>%
  rename(NumberOfFires = nFIRES, KBDI_cm = Qlcm, BurnedGroupInteval = burnedGroupInterval, AcresBurned = acresBurned)
```
