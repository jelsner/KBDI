...
TLH.df %>%
  ...
  group_by(Month) %>%
  summarize(cc = cor.test(fw, mu)$estimate)
...
Use percentiles instead of mu? Also for plotting see https://dominicroye.github.io/en/2020/visualize-climate-anomalies/
