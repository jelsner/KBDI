...
```{r}
t <- 2019
dates <- seq(as_date(paste0(t, "-01-01")), 
             as_date(paste0(t, "-12-31")), 
             by = "day")
...
Compute Qlm using the TLH data. See `ANF_Fires.Rmd`. Then loop over all grid locations computing the correlation between the Qlm computed using TLH data and the Qlm's computed using PRISM data.
