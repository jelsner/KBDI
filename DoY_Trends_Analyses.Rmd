...
TLH.df <- read.csv(file = 'Data/TLH_Daily1940-2020.csv') |>
  ...
  mutate(Year = year(Date), 
         ...
         Wind = AWND * .44704) |> # wind values appear to be mph
  filter(Year <= 2020)
...
Day-of-year statistics by variable. Use complementary colors. https://twitter.com/iamscicomm/status/1442557946320367616
```{r}
TLH_long.df <- 
  TLH.df |> 
...
Theme tips from https://dominicroye.github.io/en/2021/climate-circles/ Colors from https://image-color-picker.com/hex-code-picker
```{r}
