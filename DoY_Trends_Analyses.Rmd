...
```{r}
library(qgam)
fit0 <- qgam(list(form = MinTemp ~ s(doy, bs = "cc"), 
                                 ~ s(doy, bs = "cc")),
             data = TLH.df, qu = .1)

fit3 <- qgam(list(form = MinTemp ~ s(doy, bs = "cc") + s(Year), 
                                 ~ s(doy, bs = "cc")),
             data = TLH.df, qu = .1)

fit4 <- qgam(list(form = MaxTemp ~ s(doy, bs = "cc") + s(Year) + doy:Year, 
                                 ~ s(doy, bs = "cc")),
             data = TLH.df, qu = .95)
```
