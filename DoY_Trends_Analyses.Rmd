...
Use a cyclic effect for doy to ensure that the seasonal effect has the same value on the 31st of December and on the 1st of January.
```{r}
fit3 <- qgam(list(form = MaxTemp ~ Year + s(doy, bs = "cc"), ~ s(doy, bs = "cc")),
             data = TLH.df, qu = .9)
summary(fit3)
plot(fit3)
